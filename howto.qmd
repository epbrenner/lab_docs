...
To re-familiarize yourself with R/Python/Unix, check out these two resources in addition to Slack | [CompBio gists](https://github.com/jananiravi/compbio-gists) and [R-Ladies East Lansing](https://github.com/rladies-eastlansing).
If you are new to R-Ladies East Lansing and Women+ Data Science, check them out and join [Meetup](https://meetup.com/rladies-eastlansing) and their [Slack](https://rladies-eastlansing.slack.com/) to remain apprised of upcoming events and to connect with the local R and data science communities.

💡_If you find other useful resources, please add them to [this list](https://github.com/jananiravi/compbio-gists) (or share them with me)._
...
- [R on HPC](https://github.com/JRaviLab/group/tree/master/resources-courses/r-on-hpc)
